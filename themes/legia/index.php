...
<body>
    ...
    <div class="brand">CỬA HÀNG VẬT LIỆU XÂY DỰNG & TRANG TRÍ NỘI THẤT LÊ GIA</div>
    <div class="address-bar">UY TÍN NHẤT - CHẤT LƯỢNG NHẤT - RẺ NHẤT - NHANH CHÓNG NHẤT</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Giới thiệu về
                        <strong>Công Ty TNHH LÊ GIA</strong>
                    </h2>
                    <hr>
