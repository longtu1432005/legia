...
class Category extends Model
{
    ...
    public static $cacheTag = 'feegleweb_octoshop_categories';
    ...
    /**
     * Get parent category nested
     * @param $slug - category slug
     * @return array
     */
    public static function getParentCategoryNested($slug)
    {
        $stack = [];
        $cat = self::where('slug', $slug)->first();

        $iterator = function($cat) use (&$stack, &$iterator){
